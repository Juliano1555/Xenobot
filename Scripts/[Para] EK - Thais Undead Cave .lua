...
-- Mana Potions --
local ManasToLeave = 25				-- How many Mana Potion before leaving to refill
local WantedManas = 100 				-- Wanted amount of Mana Potions
local ManaPotID = 268 					-- Mana Potion ID
local ManaCost = 50 					-- Mana Potion Price

-- Health Potions
local HealthPotToLeave = 15             -- How many Health Potion before leaving to refill
local WantedHealths = 50 				-- Wanted amount of Health Potions
local HealthPotID = 266 				-- Health Potion ID
local HealthCost = 45 					-- Health Potion Price

-- Backpack Setup & Extra
local GoldBP = 8860                     -- Item ID of your gold backpack. ( Default Brocade Backpack )
